function test_distributive(
    ...
    @test me1 * (me2 + me3) ≈ me1 * me2 + me1 * me3
    @test mo1 * (me2 + me3) ≈ mo1 * me2 + mo1 * me3
    @test me1 * (mo2 + mo3) ≈ me1 * mo2 + me1 * mo3
    @test mo1 * (mo2 + mo3) ≈ mo1 * mo2 + mo1 * mo3
    return nothing
end
...
function test_associative(
    ...
    @test me1 * (me2 * me3) ≈ (me1 * me2) * me3
    @test mo1 * (me2 * me3) ≈ (mo1 * me2) * me3
    @test me1 * (mo2 * me3) ≈ (me1 * mo2) * me3
    @test me1 * (me2 * mo3) ≈ (me1 * me2) * mo3
    @test mo1 * (mo2 * me3) ≈ (mo1 * mo2) * me3
    @test mo1 * (me2 * mo3) ≈ (mo1 * me2) * mo3
    @test me1 * (mo2 * mo3) ≈ (me1 * mo2) * mo3
    @test mo1 * (mo2 * mo3) ≈ (mo1 * mo2) * mo3
    return nothing
end
...
function test_projection(me::MultiVector{Even})
    @test me ≈ project(me, 0) + project(me, 2) + project(me, 4) + project(me, 6)
    return nothing
end

function test_projection(mo::MultiVector{Odd})
    @test mo ≈ project(mo, 1) + project(mo, 3) + project(mo, 5)
    return nothing
end
